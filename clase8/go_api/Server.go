...
func IndexHandler(w http.ResponseWriter, r *http.Request) {
    w.Write([]byte("API GO - CLASE 8!\n"))
}

func iniciar_GO_Ubuntu(w http.ResponseWriter, r *http.Request) {
    w.Write([]byte("API GO EN UBUNTU - EN ESPERA DE DATA!\n"))
	fmt.Println("API GO EN UBUNTU - INICIADA");
}

func iniciar_GO_CentOS(w http.ResponseWriter, r *http.Request) {
    w.Write([]byte("API GO EN CENTOS - EN ESPERA DE DATA!\n"))
	fmt.Println("API GO EN CENTOS - INICIADA");
}
...
func main() {
	...
	router.HandleFunc("/iniciar-GO-Ubuntu", iniciar_GO_Ubuntu)
	router.HandleFunc("/iniciar-GO-CentOS", iniciar_GO_CentOS)
