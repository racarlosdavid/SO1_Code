...
router.get('/iniciar-JS-Ubuntu', function(req, res) {
  res.status(200).send("API NODEJS EN UBUNTU - EN ESPERA DE DATA");
  console.log("API JS EN UBUNTU - INICIADA")
});

router.get('/iniciar-JS-CentOS', function(req, res) {
  res.status(200).send("API NODEJS EN CENTOS - EN ESPERA DE DATA");
  console.log("API JS EN CENTOS - INICIADA")
});
